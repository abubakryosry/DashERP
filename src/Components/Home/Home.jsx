     ...
     <main className="flex-grow ml-0  md:ml-52 p-4 overflow-y-auto">
       <div className="w-100 h-96 flex justify-center items-center mt-12 ">
         <div className='flex flex-col items-center'>
           <h2 className="text-xl md:text-3xl mb-2 font-bold">Welcome to DASH ERP SYSTEM</h2>
           <h2 className="text-md md:text-xl mb-5 font-bold"> ERP System for Managing Employees</h2>
           <p className='font-thin text-gray-700'>
              You can head over to the Employees page in the meantime!
           </p>
           <div className="mt-7">
             <Link
               className={
